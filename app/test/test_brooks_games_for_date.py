...
class TestBrooksGamesForDate(BaseTestCase):
    ...
    DAILY_DASH_HTML = TEST_FILES_FOLDER / "brooks_daily_dash.html"
    ...
    def test_scrape_brooks_games_for_date(self):
        ...
        self.assertEqual(
            g10_pitch_dict["453344"],
            "http://brooksbaseball.net/pfx/index.php?s_type=3&sp_type=1&batterX=0&year=2018&month=4&day=17&pitchSel=453344.xml&game=gid_2018_04_17_slnmlb_chnmlb_1/&prevGame=gid_2018_04_17_slnmlb_chnmlb_1/",
        )

        g12_pitch_dict = games[12].pitcher_appearance_dict
        self.assertTrue("502327" in g12_pitch_dict)
        self.assertEqual(
            g12_pitch_dict["502327"],
            "http://brooksbaseball.net/pfx/index.php?s_type=3&sp_type=1&batterX=0&year=2018&month=4&day=17&pitchSel=502327.xml&game=gid_2018_04_17_chamlb_oakmlb_1/&prevGame=gid_2018_04_17_chamlb_oakmlb_1/",
        )
