...
class Season(Base):
    ...
    def status_report(self):
        return (
            f"BBRef Dates Scraped..........: {self.percent_complete_bbref_games_for_date:02.0f}% ({self.total_days_scraped_bbref}/{self.total_days})\n"
            f"Brooks Dates Scraped.........: {self.percent_complete_brooks_games_for_date:02.0f}% ({self.total_days_scraped_brooks}/{self.total_days})\n\n"
            f"BBRef Games Scraped..........: {self.percent_complete_bbref_boxscores_scraped:02.0f}% ({self.total_bbref_boxscores_scraped:,}/{self.total_games_tracked:,})\n"
            f"Brooks Games Scraped.........: {self.percent_complete_brooks_games_scraped:02.0f}% ({self.total_brooks_games_scraped:,}/{self.total_games_tracked:,})\n\n"
