...
class GameSubstitution(Base):
    ...
    def __repr__(self):
        return ('<GameSubstitution('
            f'incoming_player_id_br="{self.incoming_player_id_br}",'
            f'outgoing_player_id_br="{self.outgoing_player_id_br}",'
            f'inning_id="{self.db_inning_id}",'
            f'pbp_table_row_number="{self.pbp_table_row_number}"'
        ')>')
