...
def test_season_status_report(db_session):
    ...
    assert "Combined BBRef/PitchFX Data (Success/Total)..: NO 1/1" in report
    ...
    assert "Pitch Count Audited (BBRef/PFx/Removed)......: 627/627/19" in report
...
def test_season_as_dict(db_session):
    ...
    check_dict = {
        ...
        "total_pitch_apps_combined_data": 22,
        ...
        "total_pitch_count_bbref_audited": 627,
        "total_pitch_count_pitchfx": 1875,
        "total_pitch_count_pitchfx_audited": 627,
        "total_duplicate_pitchfx_removed_count": 19,
        "total_missing_pitchfx_count": 0,
        "total_extra_pitchfx_count": 0,
        "total_extra_pitchfx_removed_count": 0,
        "total_batters_faced_bbref": 160,
        "total_batters_faced_pitchfx": 160,
