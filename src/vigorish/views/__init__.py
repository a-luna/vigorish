...
from vigorish.views.team_bat_stats_view import Team_BatStats_By_Year_View
from vigorish.views.team_pitch_stats_view import Team_PitchStats_By_Year_View