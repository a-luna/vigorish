...
class Season(Base):
    ...
    def total_days_scraped_bbref(self):
        return self.date_status.total_scraped_daily_dash_bbref if self.date_status.total_scraped_daily_dash_bbref else 0
    ...
    def total_days_scraped_brooks(self):
        return (
            self.date_status.total_scraped_daily_dash_brooks if self.date_status.total_scraped_daily_dash_brooks else 0
        )
    ...
    def total_games_combined_success(self):
        return self.game_status.total_combined_data_success if self.game_status.total_combined_data_success else 0

    @hybrid_property
    def total_games_combined_fail(self):
        return self.game_status.total_combined_data_fail if self.game_status.total_combined_data_fail else 0
    ...
    def total_bbref_boxscores_scraped(self):
        return self.game_status.total_scraped_bbref_boxscore if self.game_status.total_scraped_bbref_boxscore else 0
    ...
    def total_brooks_pitch_logs_scraped(self):
        return (
            self.game_status.total_scraped_brooks_pitch_logs if self.game_status.total_scraped_brooks_pitch_logs else 0
        )
    ...
    def pitch_app_count_bbref(self):
        return self.game_status.total_pitch_app_count_bbref if self.game_status.total_pitch_app_count_bbref else 0

    @hybrid_property
    def pitch_app_count_brooks(self):
        return self.game_status.total_pitch_app_count_brooks if self.game_status.total_pitch_app_count_brooks else 0

    @hybrid_property
    def total_pitch_count_bbref(self):
        return self.game_status.total_pitch_count_bbref if self.game_status.total_pitch_count_bbref else 0
